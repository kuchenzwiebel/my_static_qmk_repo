...
const uint16_t PROGMEM test_combo3[] = {DE_EQL, DE_MORE, COMBO_END};
...
[0] = LAYOUT_ergodox_pretty(
    ...
    LSFT_T(KC_ENTER), LT(1,DE_UE)  ,  DE_OE      , DE_AE        , KC_P       ,   LT(4,DE_Z) ,        C(DE_Z) ,                                         C(KC_S),     KC_B ,   m_MENU     ,    KC_COMMA,       KC_DOT,         KC_J,           RSFT_T(KC_ENTER),
    ...
    /*                                                                     3     */ OSM(MOD_LSFT) , TT(5)      ,   DYN_MACRO_PLAY1,    /* */    M_ALT_TAB,    OSM(MOD_LALT),  OSM(MOD_LCTL)
  ),
 ...
 *  |----------+-------+-------+-------+-------+---------------|            |-------+-------+-------+-------+-------+-------+-----------|
 *  |          |       |       |       |       |       |       |            |       |       |       |       |       |       |           |
 *  |          | Undo  | Bcksp |   ↑   |  Del  | PgUp  |       |            |       | BckSp | KP_7  | KP_8  | KP_9  |   +   |   f12     |
 *  |          |       |       |       |       |       |       |            |       |       |       |       |       |       |           |
 *  |----------+-------+-------+-------+-------+-------|       |            |       |-------+-------+-------+-------+-------+-----------|
 *  |          |       |       |       |       |       |       |            |       |       |       |       |       |       |           |
 *  |          | Home/ | ←/Alt | ↓/Sft | →/Ctl |  End  |-------|            |-------|   :   | P4/Ctl| P5/Sft| P6/Alt| -/Win |           |
 *  |          | Win   |       |       |       |       |       |            |       |       |       |       |       |       |           |
 *  |----------+-------+-------+-------+-------+-------|       |            |       |-------+-------+-------+-------+-------+-----------|
 *  |          |       |       |       |Enter/ |       |       |            |       |       |       |       |       |       |           |
 ...
 */
  [1] = LAYOUT_ergodox_pretty(
     ...
     /*                                                                     3     */  _______,       _______,        _______,           KC_AUDIO_VOL_DOWN,  TD(TD_1f1)   , KC_P0
  ),
